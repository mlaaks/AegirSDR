...
class gnuradiozmq(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.connect((self.blocks_vector_to_streams_0, 3), (self.qtgui_waterfall_sink_x_0_0_0_0, 0))
        self.connect((self.blocks_vector_to_streams_0, 4), (self.qtgui_waterfall_sink_x_0_0_0_0_0, 0))
